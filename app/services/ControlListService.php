...
class ControlListService {
  ...
  public function __construct(){
    ...
    $this->sections = array(
      ...
      array('name' => 'SLO',          'action' => 'systemLevelOutcomes',  'type' => 'subsection',      'active' => true ),
      array('name' => 'OICR',    'action' => 'caseReports',          'type' => 'subsection',      'active' => true ),
      ...
      array('name' => 'Genebanks',                              'action' => 'genebank',             'type' => 'section',      'active' => true ),
      );
