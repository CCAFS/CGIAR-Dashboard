...
class ControlListService {
  ...
  public function __construct(){
    ...
    $this->sections = array(
      array('name' => 'Home',                                     'action' => 'home',                 'type' => 'section',      'active' => true, 'show' => true ),
      array('name' => 'Search by',          'action' => 'geographicScope',  'type' => 'title',      'active' => true, 'show' => true ),
      array('name' => 'Location',          'action' => 'geographicScope',  'type' => 'subsection',      'active' => true, 'show' => true ),
      array('name' => 'Partners',           'action' => 'partners',  'type' => 'subsection',      'active' => true, 'show' => true ),
      array('name' => 'SDG',                'action' => 'SDG',  'type' => 'subsection',      'active' => true, 'show' => true ),
      array('name' => 'Results',           'action' => 'systemLevelOutcomes',          'type' => 'title',        'active' => true, 'show' => true ),
      array('name' => 'SLOs',          'action' => 'systemLevelOutcomes',  'type' => 'subsection',      'active' => true, 'show' => true ),
      array('name' => 'OICRs',    'action' => 'caseReports',          'type' => 'subsection',      'active' => true, 'show' => true ),
      array('name' => 'Innovations',                              'action' => 'innovations',          'type' => 'subsection',   'active' => true, 'show' => true ),
      array('name' => 'Policies',                                 'action' => 'policies',             'type' => 'subsection',   'active' => true, 'show' => true ),
      array('name' => 'Milestones',           'action' => 'milestones',           'type' => 'subsection',      'active' => true, 'show' => true ),
      array('name' => 'Partnerships',                             'action' => 'partnerships',         'type' => 'subsection',   'active' => true, 'show' => true ),
      array('name' => 'Capacity Development',                     'action' => 'capDev',               'type' => 'subsection',   'active' => true, 'show' => true ),
      array('name' => 'Altmetric',                                'action' => 'altmetric',            'type' => 'subsection',   'active' => true, 'show' => true ),
      array('name' => 'Peer Reviewed Papers',                             'action' => 'publications',         'type' => 'subsection',   'active' => true, 'show' => true ),
      array('name' => 'MELIA Studies',                                    'action' => 'MELIA',                'type' => 'section',   'active' => true, 'show' => true ),
      array('name' => 'Genebanks',                              'action' => 'genebanks',             'type' => 'section',      'active' => true, 'show' => true ),
      array('name' => 'Glossary',                              'action' => 'glossary',             'type' => 'section',      'active' => true, 'show' => true ),
      array('name' => 'Ethiopia',                              'action' => 'ethiopia',             'type' => 'section',      'active' => true, 'show' => false ),
      );
    ...
    $this->years = array(
      ...
      array('year'=>  2021,   'name' => '2021',       'checked' => false ),
      array('year'=>  2020,   'name' => '2020',       'checked' => false ),
